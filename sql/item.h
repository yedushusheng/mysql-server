...
class Item_clone_context {
 public:
  ...
  void final_resolve_refs() { m_ref_resolver->final_resolve(); }
...
class Item_int_0 final : public Item_int {
 public:
  ...
  Item *new_item(Item_clone_context *) const override { return new Item_int_0; }
};
...
class Item_ref : public Item_ident {
  ...
  */
  ...
  explicit Item_ref()
      : Item_ident(POS(), nullptr, nullptr, nullptr), ref(nullptr) {}
...
class Item_view_ref final : public Item_ref {
 ...
 public:
  ...
  // For Item clone
  explicit Item_view_ref() : first_inner_table(nullptr) {}
