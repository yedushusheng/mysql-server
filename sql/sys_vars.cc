...
static Td_Sys_var_flagset Sys_tdsql_parallel_query_switch(
    "tdsql_parallel_query_switch",
    "tdsql_parallel_query_switch=option=val[,option=val...], where option is one of "
