...
int spider_free_prepared_trx(THD *thd, SPIDER_TRX *trx);
...
int spider_xa_recover(handlerton *hton, XA_recover_txn *xid_list, uint len,
                         MEM_ROOT *mem_root);

int spider_xa_recover_low(handlerton *hton, XID *xid_list, uint len);

xa_status_code spider_xa_commit_by_xid(handlerton *hton, XID *xid);

xa_status_code spider_xa_rollback_by_xid(handlerton *hton, XID *xid);
