...
bool spider_direct_sql_init(UDF_INIT *initid, UDF_ARGS *args,
                               char *message) {
...
long long spider_bg_direct_sql(UDF_INIT *initid, UDF_ARGS *args __attribute__((unused)), char *is_null __attribute__((unused)),
                               char *error __attribute__((unused))) {
  return spider_direct_sql_bg_end(initid);
}

bool spider_bg_direct_sql_init(UDF_INIT *initid, UDF_ARGS *args,
                                  char *message) {
...
void spider_bg_direct_sql_clear(UDF_INIT *initid, char *is_null __attribute__((unused)), char *error __attribute__((unused))) {
...
bool spider_ping_table_init(UDF_INIT *initid, UDF_ARGS *args,
                               char *message) {
...
long long spider_flush_table_mon_cache(UDF_INIT *initid __attribute__((unused)), UDF_ARGS *args __attribute__((unused)),
                                       char *is_null __attribute__((unused)), char *error __attribute__((unused))) {
  return spider_flush_table_mon_cache_body();
}

bool spider_flush_table_mon_cache_init(UDF_INIT *initid __attribute__((unused)), UDF_ARGS *args __attribute__((unused)),
                                          char *message __attribute__((unused))) {
  return false;
}

void spider_flush_table_mon_cache_deinit(UDF_INIT *initid __attribute__((unused))) {}
...
bool spider_copy_tables_init(UDF_INIT *initid, UDF_ARGS *args,
                                char *message) {
