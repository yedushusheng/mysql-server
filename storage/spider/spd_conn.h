...
const int SPIDER_LOCK_MODE_NO_LOCK = 0;
const int SPIDER_LOCK_MODE_SHARED = 1;
const int SPIDER_LOCK_MODE_EXCLUSIVE = 2;

const int SPIDER_BG_SIMPLE_NO_ACTION = 0;
const int SPIDER_BG_SIMPLE_CONNECT = 1;
const int SPIDER_BG_SIMPLE_DISCONNECT = 2;
const int SPIDER_BG_SIMPLE_RECORDS = 3;

const uint MAX_USERNAME_LEN = 32;
const uint MAX_IP_LEN = 40;

const char SPIDER_CONN_STATE_COMMIT[] = "Commit";
const char SPIDER_CONN_STATE_CONNECT[] = "Connecting";
const char SPIDER_CONN_STATE_DISCONNECT[] = "Disconnecting";
const char SPIDER_CONN_STATE_EXEC_QUERY[] = "Executing query";
const char SPIDER_CONN_STATE_INIT[] = "Init";
const char SPIDER_CONN_STATE_IN_CONN_POOL[] = "In connection pool";
const char SPIDER_CONN_STATE_ROLLBACK[] = "Rollback";
const char SPIDER_CONN_STATE_STORE_RESULT[] = "Storing result";
const char SPIDER_CONN_STATE_STORE_RESULT_END[] = "End store result";
...
public:
  ...
  SPIDER_CONN *get_conn(my_hash_value_type v, const uchar *key, uint key_len);
...
SPIDER_CONN *spider_get_conn(SPIDER_SHARE *share, int link_idx, SPIDER_TRX *trx,
                             ha_spider *spider, bool another,bool thd_chg  __attribute__((unused)),
...
void spider_conn_queue_connect(__attribute__((unused))SPIDER_SHARE *share, SPIDER_CONN *conn,
                               __attribute__((unused))int link_idx);
...
SPIDER_CONN *spider_get_conn_from_idle_connection(
    SPIDER_SHARE *share, int link_idx, const char *conn_key, ha_spider *spider,
...
bool spider_add_conn_meta_info(SPIDER_CONN *);
...
int spider_send_kill(SPIDER_CONN *, THD::killed_state);
