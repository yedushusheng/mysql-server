...
// tdsql use the fack version
#define MARIADB_BASE_VERSION 100307
#define SPIDER_MYSQL_VERSION_ID 180026

#if (defined(MARIADB_BASE_VERSION) && SPIDER_MYSQL_VERSION_ID >= 100000)
// #define SPIDER_HANDLER_START_BULK_INSERT_HAS_FLAGS
#endif

#if defined(MARIADB_BASE_VERSION) && SPIDER_MYSQL_VERSION_ID >= 100100
// #define SPIDER_SUPPORT_CREATE_OR_REPLACE_TABLE
#endif

#if defined(MARIADB_BASE_VERSION) && SPIDER_MYSQL_VERSION_ID >= 100211
...
#endif
#define SPIDIER_NOT_USING_BG_THREADS
